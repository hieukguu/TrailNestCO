...
export const articles: Article[] = [
  /* ============================== REVIEWS ============================== */
  {
    ...
    verdict: "Buy for basket area and ease of cleaning, not for the list of preset buttons. The Cosori gets the basics right and stays easy to live with, which is what decides whether an air fryer earns its space or gathers dust.",
    type: "review",
  ...
  },
  {
    ...
    quickVerdict: "Buy the Roborock S8 Pro Ultra if you want to think about vacuuming as rarely as possible. Buy the Roomba j7+ if clutter and pet accidents are your reality — avoiding one mess repays the price difference. The Eufy 11S is the sensible entry point for a small, tidy flat.",
    whoFor: [
    ...
    verdict: "Spend on navigation and the dock, not on suction numbers. The S8 Pro Ultra is the version of this product category that finally requires almost nothing from you, and that — not cleaning power — is what people are actually buying.",
    type: "review",
  ...
  },
  {
    ...
    quickVerdict: "Buy the Black Diamond Spot 400 if you want one headlamp that handles campsite chores and the occasional night hike without fuss. Choose the Petzl Actik Core if you camp often enough that disposable batteries become an annoyance, and the Fenix HL32R-T if you want most of that capability for less.",
    whoFor: [
    ...
    verdict: "The Spot 400 wins because it is unremarkable in the right way: it turns on, it is bright enough, and it keeps going. Dual fuel on the Actik Core is the single most useful feature in this category once you camp in the cold, and it is the reason to spend more.",
    type: "review",
  ...
  },
  {
    ...
    quickVerdict: "Buy the Osprey Farpoint 40 unless you have a reason not to — it is the best balance of comfort, capacity and compliance. The Tortuga Setout 45L is the better bag if you value structured organisation and mostly fly carriers with generous limits.",
    whoFor: [
    ...
    verdict: "Pick on how you pack. The Farpoint suits people who use packing cubes and want one open space; the Setout suits people who want the bag to do the organising. Both beat a roller case the moment you meet stairs or a cobbled street.",
    type: "review",
  ...
  },
  {
    ...
    quickVerdict: "For filter coffee, the OXO Brew 9-Cup is the value pick and the Moccamaster is the buy-it-for-life option. Only choose the Breville Barista Express if you actively want to make espresso and are willing to learn the process — it will not otherwise get used.",
    whoFor: [
    ...
    verdict: "Sort the grinder before the brewer. With fresh grounds and correct brew temperature, the OXO makes coffee that most people cannot distinguish from the Moccamaster. The Moccamaster earns its price on longevity and build, not on a dramatically better cup.",
    type: "review",
  ...
  },
  {
    ...
    quickVerdict: "The Salomon X Ultra 4 GTX is the boot to try first — it covers day hikes and light overnights without feeling like equipment. Try the Merrell Moab 3 if your feet are wide or the budget is tight, and the Hoka Anacapa if your days run long and your knees notice.",
    whoFor: [
    ...
    verdict: "Buy on fit first and reputation second. The X Ultra 4 GTX is the safest starting point because it suits the widest range of feet and terrain, but a Moab 3 that fits your foot properly will outperform a Salomon that does not. Order both if the retailer's returns policy allows it.",
    type: "review",
  ...
  },
  {
    ...
    quickVerdict: "If the appeal of a Nalgene is durability but you want cold water, the Hydro Flask 32oz is the straight upgrade. If the appeal is capacity but you resent carrying an empty bottle all day, the Platypus Platy 2L solves that instead. They answer different complaints.",
    whoFor: [
    ...
    verdict: "There is no single Nalgene replacement, because people leave Nalgene for opposite reasons. Decide first whether your complaint is temperature or bulk; the right bottle follows immediately from that answer.",
    type: "review",
  ...
  },
  {
    ...
    quickVerdict: "If you boil water for dehydrated meals and coffee, the BRS-3000T does the job for a fraction of the weight and price of anything else. Spend the extra on the Soto WindMaster if your trips are exposed — ridgelines, coastlines, shoulder season — where wind turns a five-minute boil into fifteen.",
    whoFor: [
    ...
    verdict: "The honest answer is that the cheapest stove here works. Buy the BRS-3000T, add a windscreen, and put the savings toward a lighter sleeping pad. Step up to the WindMaster only when you can name the trips where wind has actually cost you time.",
    type: "review",
  ...
  },
  {
    ...
    quickVerdict: "Buy the Sawyer Squeeze if you hike alone or in a pair — it is light, inexpensive and hard to break. Buy the Platypus GravityWorks 4L if you camp with a group, where the time saved not standing over a squeeze bag is worth the extra weight and cost.",
    whoFor: [
    ...
    verdict: "Match the filter to the group, not to the review score. The Sawyer Squeeze is the one most people should own; the GravityWorks is the one that transforms group camping. Whichever you pick, backflush it before it feels slow rather than after.",
    type: "review",
  ...
  },
  {
    ...
    quickVerdict: "For camping trips of a weekend or two, the Jackery Explorer 300 Plus carries enough energy for the devices most people bring. Choose the EcoFlow River 2 if you can recharge mid-trip and want that to take under an hour rather than several.",
    whoFor: [
    ...
    verdict: "Work out your actual daily watt-hours before choosing a size — most people overestimate and buy heavier than they need. At this capacity the sensible question is not which is more powerful, but which recharges on the schedule your trips allow.",
    type: "review",
  ...
  },
  {
    ...
    quickVerdict: "For most people the RTIC is the sensible buy: it holds ice long enough for the trips they actually take, at a noticeably lower price. The YETI is the better cooler, and it earns the premium only on long unsupported trips or if you value the warranty and resale value.",
    whoFor: [
    ...
    verdict: "Buy the RTIC and spend the difference on ice, or on a second cooler for drinks so the food one stays shut. The YETI is not overpriced for what it is, but for the trips most people take it solves a problem they do not have.",
    type: "review",
  ...
  },
  {
    ...
    quickVerdict: "Most people camping from a car or walking a short distance to a pitch should buy the REI Co-op Half Dome SL 2+. It is the only tent here that does not force a hard trade-off. Choose the MSR Hubba Hubba NX instead if you carry the tent for hours, and the Coleman Sundome if the budget is firm and the tent never leaves arm's reach of the boot.",
    whoFor: [
  ...
  /* ============================== OUTDOORMASTER 3 ============================== */
  {
    ...
    quickVerdict: "For most skiers the Rose Gold Revo variant is the sensible single purchase: it covers variable light, which is what a normal season actually looks like. The Dark Smoke lens is a second lens rather than an alternative first one, and the magnetic system makes owning both practical.",
    whoFor: [
    ...
    verdict: "The lens quality and the swap mechanism are the reasons to buy, and both hold up against goggles costing considerably more. Choose the Rose Gold Revo first and treat the darker lens as an accessory for bright days.",
    type: "review",
  ...
  },
  {
    ...
    quickVerdict: "If you ski in glasses, this solves a genuine problem that standard goggles do not. Take the Blue Revo lens for general use and add the yellow lens if your local conditions are frequently overcast. If you can wear contacts instead, the standard Ski Goggles PRO remains the better goggle.",
    whoFor: [
    ...
    verdict: "Judge this on whether your glasses fit, not on optics alone. As a goggle it is competent; as a solution for skiing in glasses it removes a problem that otherwise ruins the day. Measure your frames first.",
    type: "review",
  ...
  },
  {
    ...
    quickVerdict: "A full-face helmet with MIPS and a 5-star independent safety rating at this price is unusual, and the safety case does not depend on brand reputation — it rests on published third-party testing. Choose the Emerald Green variant if trail visibility matters to you; the shells are otherwise identical.",
    whoFor: [
    ...
    verdict: "The interesting part is not that it is cheap — it is that the safety claim is backed by testing anyone can look up. Confirm the fit on your own head, since a well-rated helmet that sits badly protects you less than a modest one that fits.",
    type: "review",
  ...
  /* ============================== EXTRA 3 ============================== */
  {
    ...
    quickVerdict: "Buy the Sony WH-1000XM6 if you want the quietest cabin and the best all-round feature set. Buy the Bose QuietComfort 45 if you fly long-haul and value comfort above outright cancellation. The Anker Space Q45 is the sensible choice if you fly a few times a year.",
    whoFor: [
    ...
    verdict: "Cancellation strength and comfort pull in opposite directions, and the right answer depends on flight length. Under four hours, take the Sony for the quiet. Beyond that, the Bose is the pair you will still want on your head when you land.",
    type: "review",
